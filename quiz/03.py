...
class Tab1(QWidget):
    def __init__(self):
        ...
        self.menu_gourp_box = QGroupBox('메뉴')
        ...
        self.menu_gourp_box.setLayout(self.menu_hbox_layout)

        self.vote_list_gourp_box = QGroupBox('투표 목록')
        ...
        self.vote_list_gourp_box.setLayout(self.vote_list_vbox_layout)

        self.vote_info_gourp_box = QGroupBox('투표 정보')
        ...
        self.vote_layout = QGridLayout()
        self.vote_layout.addWidget(self.menu_gourp_box, 0, 0, 1, 2)
